  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="num text-7xl font-bold text-primary">۴۰۴</h1>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "لندچی | فروشگاه اینترنتی خرید نقدی و اقساطی" },
      {
        name: "description",
        content:
          "لندچی، فروشگاه اینترنتی چند دسته‌ای با امکان خرید نقدی، اعتباری و اقساطی کالای دیجیتال، لوازم خانگی، مد و پوشاک و زیبایی.",
      },
      { property: "og:title", content: "لندچی | فروشگاه اینترنتی خرید نقدی و اقساطی" },
      {
        property: "og:description",
        content: "خرید آسان و اقساطی از فروشگاه اینترنتی لندچی با ارسال به سراسر ایران.",
      },
